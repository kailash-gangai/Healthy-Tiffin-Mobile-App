...
export default function Section({
      title, note, hero, collapsed = true, children, onToggle,
}: SectionProps) {
            ...
            <View style={s.wrap}>
                  ...
                  <View style={s.header}>
                        ...
                        <TouchableOpacity onPress={toggle} style={s.addBtn} activeOpacity={0.8}>
                              <FontAwesome5 iconStyle='solid' name={open ? 'minus' : 'plus'} size={18} color="#9B9B9B" />
                        </TouchableOpacity>
                  </View>
...
const s = StyleSheet.create({
      ...
      hero: { width: 130, height: 120, borderTopLeftRadius: 16, borderBottomLeftRadius: 16 },
      ...
      addBtn: {
            ...
            backgroundColor: '#FFF6', alignItems: 'center', justifyContent: 'center',
            marginRight: 12,
      },
