...
export default function OrderToggle({ index = 0, onChange }: Props) {
      ...
      return (
            <View style={s.container}>
                  ...
                  >
                        <Text style={[s.text, leftActive ? s.textOn : s.textOff]}>ONE DAY ORDER</Text>
                  </Pressable>
                  ...
                  >
                        <Text style={[s.text, rightActive ? s.textOn : s.textRightOff]}>ONE WEEK ORDER</Text>
                        <FontAwesome5
                              iconStyle='solid'
                              name="globe"
                              size={14}
...
const s = StyleSheet.create({
      ...
      half: { flex: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' },
